...
# функция для очистки терминала (работает лучше чем os.system('cls' if os.name == 'nt' else 'clear'))
# В данном случае используется управляющая последовательность ANSI "\033[H\033[J", которая перемещает курсор в верхний левый угол экрана ("\033[H")
# и очищает экран ("\033[J") елси количество текстовых файлов много есть смысл перед тренировкой очистить терминал.
def clear_screen():
